---
title: Como Começar no RankUP
description: Passo a passo para começar no modo RankUP do FuturyCraft: entre no servidor, conheça as minas e inicie sua progressão por ranks.
category: Servidores
icon: 🚀
order: 8
featured: true
...
O RankUP é um modo focado em **evolução**: você sobe de rank gastando money, minera para ganhar recursos e conquista prestígio após chegar ao topo.
...
Use os comandos abaixo para acessar as minas:
